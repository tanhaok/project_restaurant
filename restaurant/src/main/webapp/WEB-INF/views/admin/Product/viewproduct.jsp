    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover text-center" border="2" width="70%" >
                <thead>
                <tr>
                <tr><th>Id</th><th>Name</th><th>Description</th><th>Price</th><th>Amount</th><th>CategoryID</th><th>Image</th><th>Edit</th><th>Delete</th></tr>
                </tr>
                </thead>
                <tbody>
                <c:forEach var="product" items="${list}">
                    <tr>
                        ...
                        <td>${product.cate_id}</td>
                            ...
                            <%--            <td>${emp.img}</td>--%>
                        <td style="display: flex;justify-content: center"><img style="width: 95%" src="<c:url value="${pageContext.request.contextPath}/${product.img}"/> " alt="" border=3 height=100 width=300></td>
